...
import com.tonyhc.springbootdemo.customer.CustomerUserDetailsService;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            // Moves to the next filter in Security Filter Chain
        ...
        // Subject (email/username) exists and user not authenticated
